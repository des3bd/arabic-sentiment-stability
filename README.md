...
│   │   ├── sentiment_gemini_zero_shot.txt
│   │   └── sentiment_groq_few_shot.txt
│   ├── scripts/
│   │   ├── create_sample.py
│   │   ├── generate_paraphrases_gemini.py
│   │   ├── run_gemini_sentiment.py
│   │   ├── run_groq_sentiment.py
│   │   ├── run_arabert_sentiment.py
│   │   └── evaluate_consistency.py
│   ├── results/
│   │   ├── paraphrases_gemini.csv
│   │   ├── predictions_gemini.csv
│   │   ├── predictions_groq_gpt_oss.csv
│   │   ├── predictions_arabert.csv
...
│   │   └── failure_cases.csv
│   └── ablation/
│       ├── run_groq_fewshot_sentiment.py
│       ├── evaluate_groq_ablation.py
│       └── results/
│           ├── predictions_groq_fewshot.csv
│           ├── groq_ablation_metrics.csv
│           ├── groq_ablation_per_class_consistency.csv
│           └── groq_ablation_per_class_f1.csv
│
├── analysis/
│   ├── scripts/
