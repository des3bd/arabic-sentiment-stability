...
PROMPT_PATH = Path("experiments/prompts/sentiment_gpt_zero_shot.txt")
OUTPUT_PATH = Path("experiments/results/predictions_groq_gpt_oss.csv")
...
def main():
    ...
    print(f"Saved Groq predictions to: {OUTPUT_PATH}")
    print("Rows:", len(rows))
